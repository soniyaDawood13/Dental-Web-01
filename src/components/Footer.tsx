...
export default function Footer() {
  return (
    <footer className="bg-(--ink) text-white">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-6 grid grid-cols-2 md:grid-cols-4 gap-10">
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-xs md:text-sm text-white/55">
            {quickLinks.map((l) => (
              <li key={l.href}>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-6 md:px-8 py-4 text-xs md:text-sm text-white/45 text-center">
